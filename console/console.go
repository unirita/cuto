...
var msgs = map[string]string{
	"CTM001I": "GOCUTO MASTER STARTED. PID [%d] VERSION [%v]",
	"CTM002I": "GOCUTO MASTER ENDED. RC [%d]",
	...
	"CTM023I": "JOB [%s] STARTED AT NODE [%s]. INSTANCE [%d] JOBID [%s].",
	...
	"CTM029I": "INSTANCE [%d] ALREADY ENDED WITH NO ERROR.",
	"1":       "",
	...
	"CTS007I": "BIND ADDRESS[%v] USED PORT[%v].",
